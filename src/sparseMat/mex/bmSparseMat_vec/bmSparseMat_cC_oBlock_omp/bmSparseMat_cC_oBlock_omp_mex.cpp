...
void myFunction(int r_size_shared, 
				...
				int l_nJump_shared, 
				float* v_real_ptr0_shared, 
				float* v_imag_ptr0_shared, 
				int n_vec_32_shared, 
				float* w_real_ptr0_shared, 
				float* w_imag_ptr0_shared)
{
