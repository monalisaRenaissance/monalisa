...
void myFunction(int r_size, int* r_jump_ptr0_shared, int* r_nJump_ptr0_shared,
	...
	float* v_real_ptr0_shared, float* v_imag_ptr0_shared, int n_vec_32, float* w_real_ptr0_shared, float* w_imag_ptr0_shared);
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	v_real_ptr0 = (float*)mxGetData(prhs[12]);
	v_imag_ptr0 = (float*)mxGetImagData(prhs[12]);
	...
	// function call
	myFunction(r_size, r_jump_ptr0, r_nJump_ptr0, m_val_ptr0, l_size, l_jump_ptr0, l_nJump, nBlock, block_length_ptr0, l_block_start_ptr0, m_block_start_ptr0, v_real_ptr0, v_imag_ptr0, n_vec_32, w_real_ptr0, w_imag_ptr0);
...
#pragma omp parallel shared(r_size, r_jump_ptr0_shared, r_nJump_ptr0_shared, m_val_ptr0_shared, l_size, l_jump_ptr0_shared, l_nJump, nBlock, block_length_ptr0_shared, l_block_start_ptr0_shared, m_block_start_ptr0_shared, v_real_ptr0_shared, v_imag_ptr0_shared, n_vec_32, w_real_ptr0_shared, w_imag_ptr0_shared)
		{
			// printf("This is threat : %d . \n", omp_get_thread_num());
...
#pragma omp for
			for (int blockInd = 0; blockInd < nBlock; blockInd++)
			{
				...
				v_real_ptr1 = v_real_ptr0_shared;
				v_real_run = v_real_ptr1;

				v_imag_ptr1 = v_imag_ptr0_shared;
				v_imag_run = v_imag_ptr1;

				//w_run = w_ptr0_shared + l_block_start_ptr0_shared[blockInd]*n_vec_64;
				w_real_run = w_real_ptr0_shared + l_block_start_ptr0[blockInd] * n_vec_64;
				w_imag_run = w_imag_ptr0_shared + l_block_start_ptr0[blockInd] * n_vec_64;
	...
	else // l_sparsity case
	{
		...
		/* this is to innitial w to zero in parallel

		#pragma omp parallel shared(l_size, nBlock, n_vec_64, w_real_ptr0_shared, w_imag_ptr0_shared) // zero initialization of w
		{
		...
		w_real_run = w_real_ptr0_shared + currentBlockStart*n_vec_64;
		w_imag_run = w_imag_ptr0_shared + currentBlockStart*n_vec_64;

		currentBlockLength_2 = currentBlockLength * n_vec_64;
		...
		*/
		...
		float* w_real_run = w_real_ptr0_shared;
		float* w_imag_run = w_imag_ptr0_shared;
...
#pragma omp for
			for (int blockInd = 0; blockInd < nBlock; blockInd++)
			{
				...
				w_real_ptr1 = w_real_ptr0_shared;
				w_real_run = w_real_ptr1;
				w_imag_ptr1 = w_imag_ptr0_shared;
