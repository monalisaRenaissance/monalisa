...
#include <cufft.h>
#include <cmath>
#include "bmDFT2_CUFFT.h"

void pre_fft2(float* in_complex_ptr_0, float* in_real_ptr_0, float* in_imag_ptr_0, int Nx_u, int Ny_u, int nCh);
void post_fft2(float* out_complex_ptr_0, float* out_real_ptr_0, float* out_imag_ptr_0, int Nx_u, int Ny_u, int nCh, float F);

void bmDFT2_CUFFT(float* out_real_ptr_0, float* out_imag_ptr_0, float* in_real_ptr_0, float* in_imag_ptr_0, int Nx_u, int Ny_u, float dKx_u, float dKy_u, int nCh)
{
	...
	post_fft2((float*)out_complex_ptr_0, out_real_ptr_0, out_imag_ptr_0, Nx_u, Ny_u, nCh, F);
