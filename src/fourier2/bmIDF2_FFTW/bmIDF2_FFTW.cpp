...
void bmIDF2_FFTW(float* out_real_ptr_0, float* out_imag_ptr_0, float* in_real_ptr_0, float* in_imag_ptr_0, int Nx_u, int Ny_u, float dKx_u, float dKy_u, int nCh)
{
	...
	float F = dKx_u*dKy_u; // FFTW scales the results by Nx_u*Ny_u. 
