...
void bmPre_fft_nakatsha2_omp(	float* in_complex_ptr_0_shared, 
...
#pragma omp parallel shared(in_complex_ptr_0_shared, in_real_ptr_0_shared, in_imag_ptr_0_shared, Nx_u_shared, Ny_u_shared, nCh_shared)
	{
...
#pragma omp for
		...
		{
			in_real_ptr_run = in_real_ptr_0 + start_incr + ((long long)ind_ch)*((long long)Nx_u)*((long long)Ny_u);
			in_imag_ptr_run = in_imag_ptr_0 + start_incr + ((long long)ind_ch)*((long long)Nx_u)*((long long)Ny_u);
