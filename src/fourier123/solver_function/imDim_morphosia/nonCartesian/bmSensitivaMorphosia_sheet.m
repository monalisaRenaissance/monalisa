...
while convCond.check()
    ...
    res_z1_next             = bmMinus(  0,      private_F1(x, Tu1, n_u, nFr_1, nFr_2, K_bump)      );
    res_z2_next             = bmMinus(  0,      private_F2(x, Tu2, n_u, nFr_1, nFr_2, K_bump)      );

    dagM_res_y_next         = private_dagM(  res_y_next,  Gut, HX, HY,  n_u, nFr_1, nFr_2, KFC_conj);    
    dagF1_res_z1_next       = private_dagF1(res_z1_next, Tu1t, HX, HZ1, n_u, nFr_1, nFr_2, K_bump);
    dagF2_res_z2_next       = private_dagF2(res_z2_next, Tu2t, HX, HZ2, n_u, nFr_1, nFr_2, K_bump);
    ...
    for j = 1:nCGD
        ...
        dagM_res_y_next     =                private_dagM( res_y_next, Gut,  HX,  HY, n_u, nFr_1, nFr_2, KFC_conj);
        dagF1_res_z1_next   = bmMult(delta, private_dagF1(res_z1_next, Tu1t, HX, HZ1, n_u, nFr_1, nFr_2, K_bump));
        dagF2_res_z2_next   = bmMult(delta, private_dagF2(res_z2_next, Tu2t, HX, HZ2, n_u, nFr_1, nFr_2, K_bump));
