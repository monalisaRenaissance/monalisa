...
% function_label
function_label = 'bmSensitivaMorphosia_chain'; 
...
for c = 1:nIter
    ...
    res_z_next              = bmMinus(  0,  private_F(x, Tu, frSize, nFr, K_bump)    );
    dagM_res_y_next         = private_dagM(res_y_next, Gut, HX, HY, frSize, nFr, KFC_conj);
    dagF_res_z_next         = bmMult(delta, private_dagF(res_z_next, Tut, HX, HZ, frSize, nFr, K_bump));
