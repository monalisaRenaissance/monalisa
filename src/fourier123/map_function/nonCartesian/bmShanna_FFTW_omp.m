...
function y = bmShanna_FFTW_omp(x, G, KFC)
...
if imDim == 1
    [y_real, y_imag] = bmShanna1_FFTW_omp_mex( real(x), imag(x), real(KFC), imag(KFC), int32(N_u), ...
    ...
    y = y_real + 1i*y_imag;                         
elseif imDim == 2
    [y_real, y_imag] = bmShanna2_FFTW_omp_mex( real(x), imag(x), real(KFC), imag(KFC), int32(N_u), ...
                                G.r_size, G.r_jump, G.r_nJump, ...
                                G.m_val, ...
                                G.l_size, G.l_jump, G.l_nJump);
    ...
    y = y_real + 1i*y_imag;                         
elseif imDim == 3
    [y_real, y_imag] = bmShanna3_FFTW_omp_mex( real(x), imag(x), real(KFC), imag(KFC), int32(N_u), ...
                                G.r_size, G.r_jump, G.r_nJump, ...
                                G.m_val, ...
                                G.l_size, G.l_jump, G.l_nJump);
