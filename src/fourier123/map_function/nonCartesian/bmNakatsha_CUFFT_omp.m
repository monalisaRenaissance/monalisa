...
function x = bmNakatsha_CUFFT_omp(y, G, KFC_conj)
...
if imDim == 1
    [x_real, x_imag] = bmNakatsha1_CUFFT_omp_mex(  real(y), imag(y), real(KFC_conj), imag(KFC_conj), int32(N_u), ...
                                    G.r_size, G.r_jump, G.r_nJump, ...
                                    G.m_val, ...
                                    G.l_size, G.l_jump, G.l_nJump);
    x = x_real + 1i*x_imag; 
elseif imDim == 2
    [x_real, x_imag] = bmNakatsha2_CUFFT_omp_mex(  real(y), imag(y), real(KFC_conj), imag(KFC_conj), int32(N_u), ...
                                    G.r_size, G.r_jump, G.r_nJump, ...
                                    G.m_val, ...
                                    G.l_size, G.l_jump, G.l_nJump);
    x = x_real + 1i*x_imag; 
elseif imDim == 3
    [x_real, x_imag] = bmNakatsha3_CUFFT_omp_mex(  real(y), imag(y), real(KFC_conj), imag(KFC_conj), int32(N_u), ...
                                    G.r_size, G.r_jump, G.r_nJump, ...
                                    G.m_val, ...
                                    G.l_size, G.l_jump, G.l_nJump);
    x = x_real + 1i*x_imag; 
