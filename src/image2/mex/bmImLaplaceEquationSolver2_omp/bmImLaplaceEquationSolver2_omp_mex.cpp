...
void bmImLaplaceEquationSolver2_omp(int size_x, int size_y, float* imStart_ptr0, bool* m_ptr0, float* out_ptr0, int nIter, int nBlockPerThread); 
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	nBlockPerThread = (int)mxGetScalar(prhs[5]);
	...
	// function call
	bmImLaplaceEquationSolver2_omp(size_x, size_y, imStart_ptr0, m_ptr0, out_ptr0, nIter, nBlockPerThread); 
...
void bmImLaplaceEquationSolver2_omp(int size_x, int size_y, float* imStart_ptr0, bool* m_ptr0, float* out_ptr0, int nIter, int nBlockPerThread)
{
	...
	for (i = 0; i < nIter; i++)
	{
		bmImCrossMean2_omp(size_x, size_y, out_ptr0, out2_ptr0, nBlockPerThread);

		bmClampVal(N, out2_ptr0, m_ptr0, imStart_ptr0);
		
		bmImCrossMean2_omp(size_x, size_y, out2_ptr0, out_ptr0, nBlockPerThread);
