...
void myFunction(int size_x, int size_y, float* in_ptr0, float* out_ptr0);
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	// function call
	myFunction(size_x, size_y, in_ptr0, out_ptr0);
...
void myFunction(int size_x, int size_y, float* in_ptr0, float* out_ptr0)
{
	...
	for (i = 0; i < iMax; i++)
	{
		*out_ptr_run++ = (*xPos_ptr_run++ + *xNeg_ptr_run++ + *yPos_ptr_run++ + *yNeg_ptr_run++ + *cent_ptr_run++) / 5;
	}
