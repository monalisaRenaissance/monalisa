...
void bmIDF1_CUFFT(float* out_real_ptr_0, float* out_imag_ptr_0, float* in_real_ptr_0, float* in_imag_ptr_0, int Nx_u, float dKx_u, int nCh)
{
	...
	pre_ifft1(in_complex_ptr_0, in_real_ptr_0, in_imag_ptr_0, Nx_u, nCh);
	for (int i = 0; i < nCh; i++)
	{
	...
	post_ifft1(out_complex_ptr_0, out_real_ptr_0, out_imag_ptr_0, Nx_u, nCh, F);
