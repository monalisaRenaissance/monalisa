...
void bmDFT1_FFTW(float* out_real_ptr_0, float* out_imag_ptr_0, float* in_real_ptr_0, float* in_imag_ptr_0, int Nx_u, float dKx_u, int nCh)
{
	...
	pre_fft1((float*)in_complex_ptr_0, in_real_ptr_0, in_imag_ptr_0, Nx_u, nCh);
	...
	post_fft1((float*)out_complex_ptr_0, out_real_ptr_0, out_imag_ptr_0, Nx_u, nCh, F);
