...
void bmImLaplacian3(int size_x, int size_y, int size_z, float* in_ptr0, float* out_ptr0);
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	// function call
	bmImLaplacian3(size_x, size_y, size_z, in_ptr0, out_ptr0);
...
void bmImLaplacian3(int size_x, int size_y, int size_z, float* in_ptr0, float* out_ptr0)
{
	...
	for (i = 0; i < iMax; i++)
	{
		*out_ptr_run++ = (*xPos_ptr_run++ + *xNeg_ptr_run++ + *yPos_ptr_run++ + *yNeg_ptr_run++ + *zPos_ptr_run++ + *zNeg_ptr_run++ - 6*(*cent_ptr_run++));
	}
	// main_volume ---------------------------------------------------------------------------------
