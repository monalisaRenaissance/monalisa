							...
							)
{
	...
	long long half_size_64 = ((long long)Nx_u)*((long long)Ny_u)*((long long)Nz_u)*((long long)nCh);
	...
	bmPre_fft_nakatsha3_omp((float*)in_complex_ptr_0, interB_real_ptr_0, interB_imag_ptr_0, Nx_u, Ny_u, Nz_u, nCh);
	...
	bmPost_fft_nakatsha3_omp((float*)out_complex_ptr_0, out_real_ptr_0, out_imag_ptr_0, interA_real_ptr_0, interA_imag_ptr_0, KFC_conj_real_ptr_0, KFC_conj_imag_ptr_0, Nx_u, Ny_u, Nz_u, nCh);
	// END_FFT -----------------------------------------------------------
