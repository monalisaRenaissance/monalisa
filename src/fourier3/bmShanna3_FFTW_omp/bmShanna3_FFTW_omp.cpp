...
#include <omp.h>
#include "fftw3.h"
#include "bmShanna3_FFTW_omp.h"
#include "bmSparseMat_cC_oBlock_omp.h"
#include "bmPre_fft_shanna3_omp.h"
#include "bmPost_fft_shanna3_omp.h"
// #include <cstdio>

void bmShanna3_FFTW_omp(float* out_real_ptr_0,
						...
						)
{
	...
	long long half_size_64 = ((long long)Nx_u*Ny_u*Nz_u)*((long long)nCh); 
	...
	bmPre_fft_shanna3_omp((float*)in_complex_ptr_0, in_real_ptr_0, in_imag_ptr_0, Nx_u, Ny_u, Nz_u, nCh, KFC_real_ptr_0, KFC_imag_ptr_0);
	...
	bmPost_fft_shanna3_omp((float*)out_complex_ptr_0, inter_real_ptr_0, inter_imag_ptr_0, Nx_u, Ny_u, Nz_u, nCh);
