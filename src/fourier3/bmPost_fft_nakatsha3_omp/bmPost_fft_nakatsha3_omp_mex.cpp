...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
	...
	float* inter_complex_ptr_0 = new float[2 * nCh * Nx_u * Ny_u * Nz_u];
	float* inter_real_ptr_0 = inter_complex_ptr_0;
	float* inter_imag_ptr_0 = inter_complex_ptr_0 + nCh * Nx_u * Ny_u* Nz_u;
	...
	// function call
	bmPost_fft_nakatsha3_omp(	z_complex_ptr_0,
								out_real_ptr_0,
								out_imag_ptr_0,
								inter_real_ptr_0,
								inter_imag_ptr_0,
